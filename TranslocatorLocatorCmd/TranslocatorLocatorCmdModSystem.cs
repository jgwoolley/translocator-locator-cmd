...
public class TranslocatorLocatorCmdModSystem : ModSystem
{
    ...
    public override void StartClientSide(ICoreClientAPI api)
    {
        ...
        api.ChatCommands.Create("countwaypoints")
            .WithDescription(
                "Counts the waypoints generated by this mod within this world, as well as any others. Waypoints are stored on the client system to prevent duplication.")
    ...
    private static void CreateCommand(ICoreClientAPI api, Context context, Nf3tConfig config, LocatorCommand command)
    {
        ...
        api.ChatCommands.Create(command.Name)
            ...
            .HandleWith(args =>
            {
                ...
                return ProcessFindBlock(api, context, addWaypoints, radius,
        ...
        Func<BlockPos, BlockPos, List<WayPoint>, Block, BlockPos, bool> onBlock =
            (mapMiddlePos, playerPos, results, block, pos) =>
            {
                ...
                if (destination != null)
                {
                    ...
                    context.AddTranslocator(new SimplePos(pos.X, pos.Y, pos.Z),
                        new SimplePos(destination.X, destination.Y, destination.Z));
                }
                else
                {
